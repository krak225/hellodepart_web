...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Voyage du jours</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Tableau de bord</a></li>
            <li class="breadcrumb-item">Gestion des voyages</li>
            <li class="breadcrumb-item active">Voyage du jours</li>
          </ol>
        </div>
      </div>
    </div>
                    ...
                    @foreach($voyages as $voyage)
                      	<tr>
	                        ...
	                        <td class="text-center">
	                          	<a href="{{ route('compagnie.details.voyages.jours', [$voyage->voyage_id, Stdfn::clean_url($voyage->trajet_depart.$voyage->trajet_arrive)]) }}"><img src="{{ asset('assets/images/details.png') }}" width="26" style=""></a>
	                        </td>
                      	</tr>
                    @endforeach
                	</tbody>
