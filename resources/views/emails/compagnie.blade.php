...
.mail--header-container {
  ...
  color: white;
  font-weight: 300;
  background-image: url("https://utechnopole.com/public/images/emails/bg_emails.jpg");
  width: 575px;
}
  ...
  <table class='mail--body'>
    ...
    <table class='mail--main-container'>
      <tr class='mail--header-column mail--grow'>
        <td class='mail--h1'>VOTRE INSCRIPTION A <a href="https://www.hellodepart.com/">HELLODEPART.COM</a></td>
      </tr>
      <tr>
        <td>
          <p class='mail--paragraph__top mail--paragraph__main'>
            Bienvenu(e) <span class="nom_client">{{ $designation }}</span> dans votre plateforme HELLODEPART. Nous vous confirmons à travers ce courriel que votre inscription a bel et bien été prise en compte dans notre système.
          </p>
        </td>
      </tr> 
    </table>
    ...
    <table class='mail--main-container mail--secondary-content '>
      <tr>
        <td class="mail--row__border">
          <h3 class='mail--h3 titre_info'>Voici vos paramètres de connexion :</h3>
        </td>
      </tr>
      <tr>
        <td>
          <p class='mail--paragraph'>
            <ul>
              <li>URL : https://www.hellodepart.com/login</li>
              <li>Login : {{ $email }}</li>
	  ...
	  <tr>
        <td>
          <p class='mail--paragraph'>Toute l'équipe HELLODEPART vous souhaite encore la bienvenue et reste à votre disposition pour toute information utile.</b></p>
        </td>
      </tr>
    </table>
